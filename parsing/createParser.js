    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        var result2 = result1 !== null
          ? (function(program) { return parseHandler.program(program); })(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_LineTerminatorSequence() {
        ...
        var result15 = result14 !== null
          ? (function() { parseHandler.lineBreak(); })()
          : null;
        if (result15 !== null) {
      ...
      function parse_MultiLineComment() {
        ...
        var result2 = result1 !== null
          ? (function(comment) { parseHandler.comment(comment.join("")); })(result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_SingleLineComment() {
        ...
        if (result3 !== null) {
          ...
          var result7 = result6 !== null
            ? (function(char_) { return char_; })(result6[1])
            : null;
          if (result7 !== null) {
            var result5 = result7;
          } else {
      ...
      function parse_Identifier() {
        ...
        var savedReportMatchFailuresVar0 = reportMatchFailures;
        reportMatchFailures = false;
        var result3 = parse_ReservedWord();
        reportMatchFailures = savedReportMatchFailuresVar0;
        if (result3 === null) {
          var result1 = '';
        } else {
        ...
        if (result1 !== null) {
          var result2 = parse_IdentifierName();
          if (result2 !== null) {
      ...
      function parse_IdentifierName() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result1 = parse_IdentifierStart();
        if (result1 !== null) {
          var result2 = [];
      ...
      function parse_NumericLiteral() {
        ...
        reportMatchFailures = false;
        var savedPos0 = pos;
        var result5 = parse_HexIntegerLiteral();
        if (result5 !== null) {
          var result1 = result5;
        } else {
          var result4 = parse_DecimalLiteral();
          if (result4 !== null) {
            var result1 = result4;
          } else {
            var result1 = null;;
      ...
      function parse_DecimalLiteral() {
        ...
        var savedPos2 = pos;
        var result11 = parse_DecimalIntegerLiteral();
        if (result11 !== null) {
          if (input.substr(pos, 1) === ".") {
            var result12 = ".";
            pos += 1;
          ...
          if (result12 !== null) {
            var result16 = parse_DecimalDigits();
            var result13 = result16 !== null ? result16 : '';
            if (result13 !== null) {
              var result15 = parse_ExponentPart();
        ...
        if (result10 !== null) {
          ...
          if (result6 !== null) {
            var result7 = parse_DecimalDigits();
            if (result7 !== null) {
              var result9 = parse_ExponentPart();
          ...
          if (result5 !== null) {
            ...
            var savedPos0 = pos;
            var result2 = parse_DecimalIntegerLiteral();
            if (result2 !== null) {
              var result4 = parse_ExponentPart();
      ...
      function parse_DecimalIntegerLiteral() {
        ...
        if (result5 !== null) {
          ...
          var savedPos0 = pos;
          var result2 = parse_NonZeroDigit();
          if (result2 !== null) {
      ...
      function parse_ExponentPart() {
        ...
        var savedPos0 = pos;
        var result1 = parse_ExponentIndicator();
        if (result1 !== null) {
          var result2 = parse_SignedInteger();
          if (result2 !== null) {
            var result0 = [result1, result2];
          } else {
            var result0 = null;
      ...
      function parse_SignedInteger() {
        ...
        if (result1 !== null) {
          var result2 = parse_DecimalDigits();
          if (result2 !== null) {
            var result0 = [result1, result2];
          } else {
            var result0 = null;
      ...
      function parse_StringLiteral() {
        ...
        if (result7 !== null) {
          var result10 = parse_DoubleStringCharacters();
        ...
        if (result6 !== null) {
          ...
          if (result2 !== null) {
            var result5 = parse_SingleStringCharacters();
      ...
      function parse_DoubleStringCharacters() {
        ...
        var result1 = parse_DoubleStringCharacter();
        if (result1 !== null) {
          var result0 = [];
          while (result1 !== null) {
            result0.push(result1);
      ...
      function parse_SingleStringCharacters() {
        ...
        var result1 = parse_SingleStringCharacter();
        if (result1 !== null) {
          var result0 = [];
          while (result1 !== null) {
            result0.push(result1);
      ...
      function parse_DoubleStringCharacter() {
        ...
        if (result11 !== null) {
          ...
          if (result10 !== null) {
            ...
            var result9 = parse_LineTerminator();
            if (result9 !== null) {
              var result8 = result9;
            } else {
              var result8 = null;;
        ...
        if (result5 !== null) {
          ...
          if (result3 !== null) {
            var result4 = parse_EscapeSequence();
            if (result4 !== null) {
      ...
      function parse_NonEscapeCharacter() {
        ...
        var savedReportMatchFailuresVar0 = reportMatchFailures;
        reportMatchFailures = false;
        var result5 = parse_EscapeCharacter();
        reportMatchFailures = savedReportMatchFailuresVar0;
        if (result5 === null) {
          var result4 = '';
        } else {
        ...
        if (result1 !== null) {
          var result2 = parse_SourceCharacter();
          if (result2 !== null) {
            var result0 = [result1, result2];
          } else {
            var result0 = null;
      ...
      function parse_RegularExpressionLiteral() {
        ...
        if (result1 !== null) {
          var result2 = parse_RegularExpressionBody();
          if (result2 !== null) {
            if (input.substr(pos, 1) === "/") {
              var result3 = "/";
              pos += 1;
            ...
            if (result3 !== null) {
              var result4 = parse_RegularExpressionFlags();
              if (result4 !== null) {
      ...
      function parse_RegularExpressionBody() {
        ...
        var savedPos0 = pos;
        var result1 = parse_RegularExpressionFirstChar();
        if (result1 !== null) {
          var result2 = parse_RegularExpressionChars();
          if (result2 !== null) {
            var result0 = [result1, result2];
          } else {
            var result0 = null;
      ...
      function parse_RegularExpressionChars() {
        ...
        var result0 = [];
        var result1 = parse_RegularExpressionChar();
        while (result1 !== null) {
          result0.push(result1);
          var result1 = parse_RegularExpressionChar();
        }
      ...
      function parse_RegularExpressionBackslashSequence() {
        ...
        if (result1 !== null) {
          var result2 = parse_RegularExpressionNonTerminator();
          if (result2 !== null) {
            var result0 = [result1, result2];
          } else {
            var result0 = null;
      ...
      function parse_RegularExpressionClass() {
        ...
        if (result1 !== null) {
          var result2 = parse_RegularExpressionClassChars();
          if (result2 !== null) {
            if (input.substr(pos, 1) === "]") {
              var result3 = "]";
              pos += 1;
      ...
      function parse_RegularExpressionClassChars() {
        ...
        var result0 = [];
        var result1 = parse_RegularExpressionClassChar();
        while (result1 !== null) {
          result0.push(result1);
          var result1 = parse_RegularExpressionClassChar();
        }
      ...
      function parse_RegularExpressionFlags() {
        ...
        var result0 = [];
        var result1 = parse_IdentifierPart();
        while (result1 !== null) {
          result0.push(result1);
          var result1 = parse_IdentifierPart();
        }
